...
namespace GreatArcStudios
{
    ...
    {
        /// <summary>
        /// This stores a reference to the controller for the player camera.
        /// </summary> 
        ...
        public void Update()
        {
            ...
            if (Input.GetKeyDown(KeyCode.Escape) && mainPanel.active == false)
            {
                ...
                mainCam.transform.forward = playerCam.transform.forward;
                this.playerCam.gameObject.SetActive(false);
